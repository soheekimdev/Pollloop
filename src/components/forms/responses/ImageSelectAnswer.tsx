...
import { AnswerOption, Option, Question, QuestionType } from '@/types/forms/forms.types';
...
export default function ImageSelectAnswer({ data, value, onChange }: ImageSelectAnswerProps) {
